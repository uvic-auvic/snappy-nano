...
: ${AMENT_CURRENT_PREFIX:="/home/kraken/snappyNano/src/install/rviz_ogre_vendor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rviz_ogre_vendor/environment/vendor_package.sh"
