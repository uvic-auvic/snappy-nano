...
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\rviz_ogre_vendor\lib"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\rviz_ogre_vendor\lib64"
